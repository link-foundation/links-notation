"""Multiline quoted string tests - ported from JS/Rust implementations."""
...
def test_multiline_double_quoted_reference():
    """Test multiline double quoted reference."""
    input_text = """(
  "long
...
def test_simple_multiline_double_quoted():
    """Test simple multiline double quoted."""
    input_text = """("line1
line2")"""
    result = parser.parse(input_text)
...
def test_simple_multiline_single_quoted():
    """Test simple multiline single quoted."""
    input_text = """('line1
line2')"""
    result = parser.parse(input_text)
