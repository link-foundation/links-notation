...
class IndentedIdNestedValuesTest extends TestCase
{
    public function testIndentedIdRetainsNestedValues(): void
    {
        $cases = [
        ...
        foreach ($cases as [$source, $expected]) {
            $this->assertSame($expected, Formatter::formatLinks($parser->parse($source)), $source);
        }
    }
}
