...
// src/Parser.js
var DEFAULT_PUNCTUATION_SYMBOLS = [",", ".", ";", "!", "?"];
...
class Parser {
  constructor(options = {}) {
    ...
    this.tokenizeSymbols = options.tokenizeSymbols !== false;
  ...
  parse(input) {
    ...
    try {
      ...
      const rawResult = peg$parse(processedInput);
