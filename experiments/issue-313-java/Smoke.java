...
public class Smoke {
  public static void main(String[] args) throws Exception {
    ...
    for (String[] testCase : cases) {
      String actual = Link.formatLinks(parser.parse(testCase[0]));
      if (!actual.equals(testCase[1])) {
        throw new AssertionError("Expected " + testCase[1] + ", got " + actual);
      }
    }
    System.out.println("6 issue #313 cases passed");
  }
}
