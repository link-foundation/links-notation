<!-- Verbatim copy of
     ...
     as read on 2026-08-28, kept here so BEST-PRACTICES-COMPLIANCE.md is checked against a
     fixed text rather than a moving upstream one. The only edit is that the
     repository-relative links below were rewritten to absolute hive-mind URLs, because
     they do not resolve from this directory. -->
